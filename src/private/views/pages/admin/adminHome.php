      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="<?php echo $settings['siteurl']?>pages/admindash" class="text-white">Go to dashboard</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="album py-5 bg-light">
              ...
              <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <form action="'.$settings['siteurl'].'pages/viewBlogAdmin" method="POST">
                      <input type="hidden" name="id" value="'.$v->blog_id.'">
                      <input class="btn btn-success" type="submit" name="submit" value="View Full Blog">
                      </form>
                      <form action="'.$settings['siteurl'].'pages/editBlog" method="POST">
                      <input type="hidden" name="id" value="'.$v->blog_id.'">
          ...
          <form action="http://localhost:8080/pages/addNewBlog" method="POST">
...
<footer class="text-muted py-5">
  <div class="container">
    ...
    <script src="<?php echo $settings['siteurl']?>node_modules/bootstrap/dist/js/bootstrap.bundle.min.js" 
    integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" 
    crossorigin="anonymous"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
	<script src="<?php echo $settings['siteurl']?>script1.js"></script>
